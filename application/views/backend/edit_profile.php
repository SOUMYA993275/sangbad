...
<body>
    ...
    <?php include_once ('header.php');?>
        ...
        <div class="ibox-content">
                            ...
                            <form id="form" action="<?=site_url('Profile/UpdateProfile');?>" enctype="multipart/form-data" method="POST" class="wizard-big">
							<?php
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <!--div class="form-group">
                                                ...
                                                <input id="mobile" name="mobile" type="number" class="form-control required" title="You Can't Edit this, Contact Admin" value="<?=$mn->mobile;?>" disabled placeholder="Enter Mobile Number" onKeyPress="if(this.value.length==10) return false;" pattern="[7-9]{1}[0-9]{9}/^-?\d+\.?\d*$/">
                                            </div-->
                                            <div class="form-group">
                                                <label>Email *</label>
                                        ...
                                        <div class="col-lg-6">
											...
											<!--div class="form-group">
                                                ...
                                                <select id="role" name="status" title="You Can't Edit this, Contact Admin" disabled type="text" class="form-control required">

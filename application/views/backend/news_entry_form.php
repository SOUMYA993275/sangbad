							...
							<div class="ibox-content">
								<div class="col-lg-12">
									<div class="panel panel-default" style="border: none;">
										<form class="form-horizontal" role="form" name="myForm" enctype="multipart/form-data" accept-charset="utf-8" method="POST" onsubmit="return validateForm()" action="">
											<div class="row">
												<div class="col-lg-3">                        
													<div class="block">
																...
																<div class="row">
																	<div class="col-lg-12" style="padding-left: 0px;padding-right: 0px;">
																		...
																		?>
																			...
																			<div class="col-lg-3">
																				<label class="switch">
																					<input type="radio" name="switch-radio1"  value="<?=$cg->menucode;?>" required>
																					<span></span>
																				</label>
																			</div>
																		<?php
																	...
																	<div class="col-lg-12" style="padding-left: 0px;padding-right: 0px;">
																		...
																		?>
																			...
																			<div class="col-lg-3">
																				<label class="switch">
																					<input type="radio" name="switch-radio1"  value="<?=$td->tabcode;?>" required/>
																					<span></span>
																				</label>
																			</div>
																		<?php
												...
												<div class="col-lg-9">
													<div class="form-group">
														...
														<input id="btitle" name="btitle" type="text" placeholder="Enter Bengali Title" class="form-control" required>
													</div>
													<div class="row">
														<div class="col-lg-10 form-group">
															<label>Title<span style="color:red;"> (English)</span></label>
															<input id="etitle" name="etitle" type="text" placeholder="Enter English Title" class="form-control" required>
														</div>
														<div class="col-lg-2 form-group">
															<label><span style="font-size :17px; font-weight: bold;"> শিরোনাম</span></label>
															<input id="checkbox4" name="sironam" type="checkbox" style="width: 20px;height: 20px;" value="1" class="form-control">
														</div>
													</div>
													<div class="row">
														<div class="col-lg-6">
													...
													<div class="row">
														<div class="col-lg-4">
															<div class="form-group">
																...
																<input id="image1" name="image1" type="file" accept="image/gif, image/jpeg, image/JPEG, image/png, image/PNG, image/jpg, image/JPG" placeholder="Select Image" class="form-control" required>
															</div>
														</div>
														<div class="col-lg-4">
															<div class="form-group">
																<label>Image 2<span style="color:red;"> (Optional)</span></label>
																<input id="image2" name="image2" type="file" accept="image/gif, image/jpeg, image/JPEG, image/png, image/PNG, image/jpg, image/JPG" placeholder="Select Image" class="form-control" >
															</div>
														</div>
														<div class="col-lg-4 form-group">
															<label>Collected From :</label>
															<input id="collected" name="collected" type="text" placeholder="Enter News Source" class="form-control" value="সংগৃহীত" required>
														</div>
													</div>
													<div class="row">
														<div class="col-lg-6 form-group">
															<img style="border: 2px solid black;height:140px;width:270px;display:none;" id="preview1"  src="" alt="Image1" >
														</div>
														<div class="col-lg-6 form-group">
															<img style="border: 2px solid black;height:140px;width:270px;display:none;" id="preview2"  src="" alt="Image2" >
														</div>
													</div>
													<div class="form-group">
														<label>Youtube Link<span style="color:red;"> (Optional)</span></label>
														<input id="ylink" name="ylink" type="url" placeholder="Enter Youtube Link" class="form-control">
													</div>
													<div class="form-group">
														<label>Other Link (Instagram/Twitter)<span style="color:red;"> (Optional)</span></label>
														<textarea id="olink" name="olink" type="url" placeholder="Enter other Link" class="form-control"></textarea>
													</div>
													<div class="form-group">
														<label>News Details</label>
														<textarea id="n_details" name="n_details" class="form-control summernote" required></textarea>

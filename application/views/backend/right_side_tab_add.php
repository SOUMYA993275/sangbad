											...
											<div class="row">
												<div class="col-lg-6">
													<div class="form-group">
														...
														<input id="tabname" name="tabname" type="text" placeholder="Enter Tab Name" class="form-control" required>
													</div>
													<div class="form-group">
														<label>Tab Code<span style="color:red;"> (English)</span></label>
														<input id="tabcode" name="tabcode" type="text" placeholder="Enter Tab Code" oninput="this.value = this.value.toUpperCase()" class="form-control" required>
													</div>
													<div class="row">
														<div class="col-lg-8">
															<div class="form-group">
																<label>Tab Image<span style="color:red;"> (Image Size Should be 683*384 px)</span></label>
																<input id="tabimage" name="tabimage" type="file" accept="image/gif, image/jpeg, image/JPEG, image/png, image/PNG, image/jpg, image/JPG" placeholder="Select Tab Image" class="form-control" required>
															</div>
														</div>
														<div class="col-lg-4">
															<div class="form-group">
												...
												<div class="col-lg-5">
													<img style="border: 2px solid black;height:250px;width:360px;display:none;" id="preview1"  src="" alt="Image1" >
												</div>

                    ...
                    <tr>
                        <td class="content-wrap">
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        Welcome to Sangbad Raatdin. You are now in our family. To activate your account please click on the button.
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                ...
                                <tr>
                                    <td class="content-block aligncenter">
                                        <a href="<?=base_url('');?>User/active?url=<?=$email;?>" class="btn-primary">Activate Your account.</a>
                                    </td>
                                </tr>
                              </table>
                        </td>

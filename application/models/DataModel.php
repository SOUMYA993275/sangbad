...
class DataModel extends CI_Model
{
	...
	function getAdvertise($postData=null)
	{
		 ...
		 $searchQuery = "";
		 if($searchValue != ''){
			$searchQuery = " (givenby like '%".$searchValue."%' or description like '%".$searchValue."%' or url like'%".$searchValue."%' ) ";
		 }

		 ## Total number of records without filtering
		 $this->db->select('count(*) as allcount');
		 $records = $this->db->get('advertisementmaster')->result();
		 $totalRecords = $records[0]->allcount;
